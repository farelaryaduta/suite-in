...
<head>
    ...
    <title>@yield('title', 'suite.in Partner - Grow Your Hotel Business')</title>
            ...
            <div class="flex justify-between items-center h-20">
                <div class="flex items-center">
                    <a href="{{ route('partner.index') }}" class="flex items-center gap-2">
                        <span class="text-2xl font-bold text-gray-900">suite.<span
                                class="text-blue-600">in</span></span>
                        <span
                            class="bg-blue-100 text-blue-800 text-xs font-semibold px-2.5 py-0.5 rounded border border-blue-200">PARTNER</span>
                    </a>
                </div>
                <div class="hidden md:flex items-center space-x-8">
                    <a href="#benefits" class="text-gray-600 hover:text-blue-600 font-medium transition-colors">Why
                        Us</a>
                    <a href="#how-it-works" class="text-gray-600 hover:text-blue-600 font-medium transition-colors">How
                        it Works</a>
                ...
                <div class="flex items-center space-x-4">
                    ...
                    @else
                        <a href="{{ route('partner.login') }}"
                            class="text-gray-700 hover:text-blue-600 font-medium">Login</a>
                        <a href="{{ route('partner.register') }}"
                            class="bg-blue-600 text-white px-6 py-2.5 rounded-full font-medium hover:bg-blue-700 transition-all shadow-lg shadow-blue-600/20">Register
                            Property</a>
                    @endauth
                </div>
            </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                <div class="col-span-1 md:col-span-2">
                    <span class="text-2xl font-bold text-white">suite.<span class="text-blue-500">in</span></span>
                    <p class="mt-4 text-gray-400 max-w-xs">
                        The most trusted partner for hotel owners. Grow your business with our world-class technology
                        and support.
                    </p>
                </div>
                <div>
