...
<head>
    ...
    <title>@yield('title', 'Partner Dashboard - suite.in')</title>
...
<body class="antialiased min-h-screen flex flex-col bg-slate-50">
            ...
            <div class="flex justify-between h-16">
                <div class="flex">
                    <div class="flex-shrink-0 flex items-center">
                        <a href="{{ route('partner.dashboard') }}" class="flex items-center gap-2">
                            <span class="text-xl font-bold text-gray-900">suite.<span
                                    class="text-blue-600">in</span></span>
                            <span
                                class="bg-gray-100 text-gray-600 text-xs font-semibold px-2 py-0.5 rounded">PARTNER</span>
                        </a>
                    </div>
                ...
                <div class="flex items-center">
                    <div class="flex-shrink-0">
                        <a href="{{ route('partner.hotels.create') }}"
    ...
    <main class="flex-1 py-10">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            @if(session('success'))
                <div
                    class="mb-6 flex items-center gap-3 rounded-lg bg-green-50 border border-green-100 px-4 py-3 shadow-sm">
