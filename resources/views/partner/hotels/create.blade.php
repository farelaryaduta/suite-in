...
@section('content')
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        <form action="{{ route('partner.hotels.store') }}" method="POST" enctype="multipart/form-data" class="divide-y divide-gray-200">
            ...
            <div class="p-8 bg-gray-50 border-t border-gray-200">
                <div class="md:grid md:grid-cols-3 md:gap-6">
                    <div class="md:col-span-1">
                        ...
                        <p class="mt-1 text-sm text-gray-500">
                            Add rooms to your property. You can add more later.
                        </p>
                    </div>
                    <div class="mt-5 md:mt-0 md:col-span-2">
            ...
            <!-- Form Actions -->
            <div class="px-8 py-5 bg-white border-t border-gray-200 flex justify-end">
    ...
    <script>
        ...
        function addRoom() {
            ...
            // Convert string back to DOM node provided by template logic or just insert HTML
            // Cleaner way:
            const tempDiv = document.createElement('div');
            tempDiv.innerHTML = html;
            const newBlock = tempDiv.firstElementChild;
            
            newBlock.querySelector('.room-title').textContent = 'Room ' + (roomIndex + 1);
